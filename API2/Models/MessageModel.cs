...
namespace MessageModel
{
    public class MessageModel{
        ...
        public static async Task<string> RequestReportDetailed(DateTime BeginningDate, DateTime EndDate, string Receiver)
        {
            ...
            string queryParams = $"StartDate={Uri.EscapeDataString(BD)}&EndDate={Uri.EscapeDataString(ED)}&Receiver={Uri.EscapeDataString(Receiver.ToString())}";
            //  $"&Delivered={Uri.EscapeDataString(Delivered.ToString())}";
            // ?StartDate=2023%2F09%2F28&EndDate=2023%2F09%2F28&Receiver=&Delivered=vamos+tentar+novamente <- API
            // ?StartDate=2023%2F09%2F01&EndDate=2023%2F09%2F30&Receiver=&Delivered=vamos+tentar+novamente <- mine
            url += "?" + queryParams;
