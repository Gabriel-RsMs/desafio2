...
namespace UserModel
{
    public class UserModel{
        ...
        public static bool CreateUser(string Email, string passwd, string phone_number, string CPF){
        ...
        public static User GetUserByEmail(string Email){
            string GetUserByEmailSQL = "SELECT * FROM USERS WHERE EMAIL = " + Email + ";";
            System.Console.WriteLine(GetUserByEmailSQL);
            return RequestBD<User>(GetUserByEmailSQL);
        }
