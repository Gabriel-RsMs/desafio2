...
namespace Modelclass
{
    public class Model{
        ...
        protected static T RequestBD<T>(string SQL) where T : IConvertible{
        ...
        private static int CheckType(User user){
        ...
        public static string LoginCheck(string EmailGiv, string PassGiv){
            ...
            string pass = RequestBD<string>(CheckSQL);
            if(pass == null){
                return "Email incorreto";
            }
            if(PasswordHasher.VerifyPassword(pass, PassGiv)){
                return "Logado";
            }
        ...
        public static string DeductBalance(User user){
            ...
            public static void CreateUser(User user, string passwd){
                string SecPass = PasswordHasher.HashPassword(passwd);
